...
const EditTask = () => {
  ...
  return (
    ...
    >
      <div className="col-12 col-sm-10 col-md-12 col-lg-12">
        <Card
          className="shadow-sm"
          style={{ backgroundColor: theme === "dark" ? "#17314dff" : "#fff", color: theme === "dark" ? "#f0f0f0" : "#000" }}
        >
          <Card.Body>
            <h2 className="mb-4 text-center .fs-small-heading" style={{ color: theme === "dark" ? "#aad4f5" : "#333" }}>
              Edit Task
            </h2>
            <Form onSubmit={handleSubmit}>
              <div className="mb-3">
                <Form.Label className="fs-responsive" style={{ color: theme === "dark" ? "#aad4f5" : "#333" }}>
                  Task Title
                </Form.Label>
                <Form.Control
                  type="text"
