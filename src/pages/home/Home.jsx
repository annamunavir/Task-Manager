...
const Home = () => {
  const { setIsLogin, state } = useContext(GlobalContext);
      ...
      <div className="row justify-content-center text-center w-100">
        <div className="col-12 col-md-8 col-lg-6">
          <div className="p-4 p-md-5 rounded-4">
            {/* Responsive heading */}
            <h1
              className="fw-bold mb-4 fs-heading"
              style={{
                background: "linear-gradient(135deg, #667eea 0%, #712fb3ff 100%)",
            ...
            <p className="lead mb-4 fs-responsive">
              ...
              <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
                <Link to="/authentication">
                  <Button
                    ...
                    variant="primary"
                    size="lg"
                    className="px-4 shadow w-100 fs-responsive"
                  >
                    Login
                  </Button>
                </Link>
